# Purchasing Power API - Examples

This folder contains example code for using the Purchasing Power API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/purchasingpower',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/purchasingpower](https://docs.apiverve.com/ref/purchasingpower)
