...
namespace APIVerve.API.PurchasingPower
{
    ...
    /// <summary>
    /// Client for the PurchasingPower API
    /// </summary>
    public class PurchasingPowerAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/purchasingpower";
        ...
        {
            { "amount", new ValidationRule { Type = "number", Required = true, Min = 0 } },
            { "from", new ValidationRule { Type = "string", Required = true, MinLength = 4, MaxLength = 4, Format = "year" } },
            { "to", new ValidationRule { Type = "string", Required = false, MinLength = 4, MaxLength = 4, Format = "year" } }
        };
        ...
        public PurchasingPowerAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PurchasingPowerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PurchasingPowerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, PurchasingPowerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(PurchasingPowerQueryOptions options)
        {
        ...
        public ResponseObj Execute(PurchasingPowerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PurchasingPowerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PurchasingPowerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PurchasingPowerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PurchasingPowerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PurchasingPowerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(PurchasingPowerQueryOptions options)
        {
