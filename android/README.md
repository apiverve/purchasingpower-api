...
```gradle
dependencies {
    implementation 'com.github.apiverve:purchasingpower-api:1.1.14'
}
```
...
```java
import com.apiverve.purchasingpower.PurchasingPowerAPIClient;
import com.apiverve.purchasingpower.APIResponse;
import com.apiverve.purchasingpower.APIException;

// Initialize the client
PurchasingPowerAPIClient client = new PurchasingPowerAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("amount", 100);
    parameters.put("from", "1990");
    parameters.put("to", "2024");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/purchasingpower](https://docs.apiverve.com/ref/purchasingpower)
...
- **Documentation:** [https://docs.apiverve.com/ref/purchasingpower](https://docs.apiverve.com/ref/purchasingpower)
- **Issues:** [GitHub Issues](https://github.com/apiverve/purchasingpower-api/issues)
