// Package purchasingpower provides a Go client for the Purchasing Power API.
//
// For more information, visit: https://apiverve.com/marketplace/purchasingpower?utm_source=go&utm_medium=readme
package purchasingpower
...
// Request contains the parameters for the Purchasing Power API.
//
// Parameters:
//   - amount (required): number - The dollar amount to convert [min: 0]
//   - from (required): string - Starting period in YYYY or YYYY-MM format (data available from 1947) [minLength: 4, maxLength: 7]
//   - to: string - Ending period in YYYY or YYYY-MM format. Omit for current. [minLength: 4, maxLength: 7]
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"from": {Type: "string", Required: true, MinLength: intPtr(4), MaxLength: intPtr(7)},
		"to": {Type: "string", Required: false, MinLength: intPtr(4), MaxLength: intPtr(7)},
	}
...
// ResponseData contains the data returned by the Purchasing Power API.
type ResponseData struct {
	...
	AdjustedPeriod string `json:"adjustedPeriod"`
	CumulativeInflation float64 `json:"cumulativeInflation"`
	Multiplier float64 `json:"multiplier"`
	Explanation string `json:"explanation"`
	FromCPI float64 `json:"fromCPI"`
	ToCPI float64 `json:"toCPI"`
}
